...
class CouponControllerTest : StringSpec({
    ...
    "redeemCoupon should return OK with success message when coupon is redeemed successfully" {
        ...
        // When: Calling the redeemCoupon method of the controller with the coupon ID.
    ...
    "createCoupon should return OK with success message when coupon is created successfully" {
        // Given: A CouponCreate object and the coupon service create method is mocked.
        ...
        // When: Calling the createCoupon method of the controller with the couponCreate object.
